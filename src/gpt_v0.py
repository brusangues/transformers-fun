...
class Head(nn.Module):
    ...
    def __init__(self, n_embd, context_len, head_size, dropout):
        super().__init__()
...
class MultiHeadAttention(nn.Module):
    ...
    def __init__(self, n_embd, context_len, n_head, head_size, dropout):
        super().__init__()
        self.heads = nn.ModuleList(
            [Head(n_embd, context_len, head_size, dropout) for _ in range(n_head)]
        )
